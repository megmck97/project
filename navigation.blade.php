        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <x-logo class="block w-auto h-4 text-red-600 fill-current" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="/user/{{ Auth::user()->uuid }}">Profile</x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link href="/settings/account">Account</x-dropdown-link>
                        <x-dropdown-link href="/settings/password">Password</x-dropdown-link>
                        <!-- Authentication -->
